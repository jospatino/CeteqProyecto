...
public class ProcesoServiceImpl implements ProcesoService{
	...
	@Override
	public List<ProcesoBean> findByAlumnoInProcess(short estatus) {
		List<ProcesoModel> procesoList = procesoRepo.findAlumnoInProcess(estatus);
		List<ProcesoBean> procesoBeanList = new ArrayList<ProcesoBean>();
		for(ProcesoModel procesoM : procesoList) {
			ProcesoBean procesoBean = new ProcesoBean();
			procesoBean.setIdProceso(procesoM.getIdProceso());
			procesoBean.setDescripcion(procesoM.getDescripcion());
