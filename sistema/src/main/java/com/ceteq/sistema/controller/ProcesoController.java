...
public class ProcesoController {
	...
	@GetMapping("/get/{estatus}")
	public ResponseEntity<List<ProcesoBean>>getProcesoAlumno(@PathVariable short estatus){
		return new ResponseEntity<>(this.procesoService.findByAlumnoInProcess(estatus), HttpStatus.OK);
	}
}
